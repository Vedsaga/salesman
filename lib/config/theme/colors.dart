...
// make purple gradient gradient(90deg, #692095 0%, #9532D1 100%, #9C2BE1 100%);
...
// create purpleGradient background: linear-gradient(90deg, #FFC107 0%, #FFD54F 98.29%, #FFD54F 98.29%);
